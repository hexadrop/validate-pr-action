...
var require_redirect_interceptor = __commonJS((exports2, module2) => {
...
var require_lib = __commonJS((exports2) => {
  ...
  Object.defineProperty(exports2, "__esModule", { value: true });
  exports2.HttpClient = exports2.HttpClientResponse = exports2.HttpClientError = exports2.MediaTypes = exports2.Headers = exports2.HttpCodes = undefined;
  exports2.getProxyUrl = getProxyUrl2;
...
class Context {
  constructor() {
    ...
    if (process.env.GITHUB_EVENT_PATH) {
      if (import_fs2.existsSync(process.env.GITHUB_EVENT_PATH)) {
        this.payload = JSON.parse(import_fs2.readFileSync(process.env.GITHUB_EVENT_PATH, { encoding: "utf8" }));
      } else {
...
` + `Please comment on the issue and wait for it to be labelled ${config.approvedLabel}.`);
  ...
  if (!typeResult.valid) {
    ...
    const changesetFiles = findChangesetFiles(files, config.changesetPath, config.changesetReadme);
    if (changesetFiles.length === 0) {
      messages.push(`PR labelled ${typeResult.typeLabel} must include a changeset.
...
async function run() {
  try {
    ...
    const result = await validate(octokit, context3.repo.owner, context3.repo.repo, pullRequest.number, config);
